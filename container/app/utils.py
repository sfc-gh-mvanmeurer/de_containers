"""
FGCU Canvas ETL - Utility Functions
====================================
...
class SnowflakeConnection:
    ...
    def __init__(
        ...
        self.connection_params = {
            ...
            "database": database or os.getenv("SNOWFLAKE_DATABASE", "FGCU_CANVAS_DEMO"),
            "schema": schema or os.getenv("SNOWFLAKE_SCHEMA", "RAW"),
            "warehouse": warehouse or os.getenv("SNOWFLAKE_WAREHOUSE", "FGCU_TRANSFORM_WH"),
...
def get_env_config() -> dict:
    ...
    """
    return {
        "database": os.getenv("SNOWFLAKE_DATABASE", "FGCU_CANVAS_DEMO"),
        "schema_raw": os.getenv("SNOWFLAKE_SCHEMA_RAW", "RAW"),
        "schema_curated": os.getenv("SNOWFLAKE_SCHEMA_CURATED", "CURATED"),
        "warehouse": os.getenv("SNOWFLAKE_WAREHOUSE", "FGCU_TRANSFORM_WH"),
