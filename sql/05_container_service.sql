/*
================================================================================
FGCU Canvas Data Engineering - Snowpark Container Services Setup
================================================================================
...
-- <orgname>-<acctname>.registry.snowflakecomputing.com/fgcu_canvas_demo/compute/canvas_images
...
spec:
  containers:
    - name: canvas-etl
      image: /fgcu_canvas_demo/compute/canvas_images/canvas-etl:latest
      env:
...
GRANT USAGE ON SERVICE CANVAS_ETL_SERVICE TO ROLE FGCU_DATA_ENGINEER;
GRANT USAGE ON FUNCTION RUN_CANVAS_ETL(VARCHAR) TO ROLE FGCU_DATA_ENGINEER;
GRANT USAGE ON FUNCTION GET_ETL_STATUS() TO ROLE FGCU_DATA_ENGINEER;
GRANT USAGE ON FUNCTION RUN_TRANSFORMATION(VARCHAR, VARIANT) TO ROLE FGCU_DATA_ENGINEER;
...
FROM TABLE(
    FGCU_CANVAS_DEMO.COMPUTE.CANVAS_ETL_SERVICE!GET_SERVICE_LOGS('canvas-etl', 100)
);
...
-- View service logs
-- SELECT * FROM TABLE(FGCU_CANVAS_DEMO.COMPUTE.CANVAS_ETL_SERVICE!GET_SERVICE_LOGS('canvas-etl', 50));
